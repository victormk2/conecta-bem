...
class EventControllerTest {
    ...
    void registerReturnsCreatedParticipation() {
        ...
        when(eventService.register(eventId, userId)).thenReturn(dto);
    ...
    void cancelRegistrationReturnsNoContentWhenCanceled() {
        UUID eventId = UUID.randomUUID();
        when(eventService.cancelRegistration(eventId, userId)).thenReturn(true);
    ...
    void listParticipantsReturnsRegistrations() {
        ...
        when(eventService.listParticipants(eventId, userId)).thenReturn(List.of(dto));
    ...
    void updateParticipationStatusReturnsUpdatedRegistration() {
        ...
        when(eventService.updateParticipationStatus(eventId, volunteerId, request, userId)).thenReturn(dto);
    ...
    void justifyAbsenceReturnsUpdatedRegistrationForSameUser() {
        ...
        when(eventService.justifyAbsence(eventId, userId, request)).thenReturn(dto);
    ...
    void myRegistrationsReturnsHistory() {
        EventRegistrationDTO dto = new EventRegistrationDTO();
        dto.setVolunteerId(userId);
        when(eventService.listVolunteerHistory(userId, true)).thenReturn(List.of(dto));
